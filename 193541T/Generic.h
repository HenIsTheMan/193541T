...
void CursorPosCallback(GLFWwindow*, double xPos, double yPos){
    ...
    //float x = (2.f * float(xPos)) / 800.f - 1.f, y = 1.f - (2.f * float(yPos)) / 600.f;
    //glm::vec3 rayNDC(x, y, -1.f);
    //glm::vec4 rayClipSpace(rayNDC, 1.f);
    //glm::vec4 rayViewSpace(glm::inverse(glm::perspective(glm::radians(FOV), 800.f / 600.f, .1f, 100.f)) * rayClipSpace);
    //rayViewSpace = glm::vec4(rayViewSpace.x, rayViewSpace.y, -1.f, 0.f);
    //glm::vec3 rayWorldSpace(glm::inverse(glm::lookAt(glm::vec3(0.f, 0.f, -5.f), glm::vec3(0.f), glm::vec3(0.f, 1.f, 0.f)) * rayViewSpace));
